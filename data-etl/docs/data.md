...
Objective:
- Define the relevant files and relationship between each data set

Data broken down by year
- All data between 2000-2019 in the state of Virginia, USA

## Downloading Data

The data can be [**HERE**](https://crime-data-explorer.fr.cloud.gov/downloads-and-docs).
Note:
- All credit for the data due for Federal Bureau of Investigation for providing the data source
- Note: Other states can also be investigated alongside this data set


## Data-Recap

Below is an excerpt from the National Incident-Based Reporting System (NIBRS) system. Data in these tables is broken into roughly ~40 distinct tables. Approximately ~20 tables/csv files are mere lookup tables.
